...
## Health indicators ----
#'NOTE [Q: is this supposed to be a copy of the other table? A: yes basic and health are almost similar but one has expounded geography // these indicactors come from the basicDT table anyways]
